...
INSERT INTO clasificacion (id_clasificacion, nombre_clasificacion)
VALUES (1, 'Mamíferos'),
       (2, 'Aves'),
       (3, 'Reptiles'),
       (4, 'Anfibios'),
...
INSERT INTO habitat (id_habitat, nombre_habitat)
VALUES (1, 'Terrestre'),
       (2, 'Acuático'),
       (3, 'Aéreo'),
       (4, 'Otro');
...
INSERT INTO animal (id_animal, nombre_animal, descripcion_animal, id_clasificacion_id, id_alimentacion_id, id_habitat_id)
VALUES 
...
VALUES ("eregr", "rhtghgr", 5, 2, 3);

SELECT id_clasificacion, COUNT(id_clasificacion) AS total FROM clasificacion; 

SELECT id_animal_log,operacion,id_animal, nombre_animal, descripcion_animal, nombre_clasificacion, tipo_alimento, nombre_habitat, fecha 
    FROM animal_log
        left JOIN clasificacion ON animal_log.id_clasificacion_id=clasificacion.id_clasificacion 
        left JOIN alimentacion ON animal_log.id_alimentacion_id=alimentacion.id_alimentacion
        left JOIN habitat ON animal_log.id_habitat_id=habitat.id_habitat;
