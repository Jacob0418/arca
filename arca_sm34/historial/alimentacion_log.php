...
<head>
  <title>Historial Alimentacion</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
...
<header>
        ...
        <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="alimentacion_log.php">Alimentación</a>
              </li>
              <li class="nav-item">
  ...
  <main>
    ...
    <div class="mb-3">
    <h5 class="text-secondary">HISTORIAL ALIMENTACIÓN</h5>
<table class="table table-bordered">
<div class="mb-3">
<thead>
    <tr>
        <th scope="col" class="text-secondary">#</th>
        <th scope="col" class="text-secondary">Tipo de operacion</th>
        <th scope="col" class="text-secondary">ID de Alimentación</th>
        <th scope="col" class="text-secondary">Nombre de la Alimentación</th>
        <th scope="col" class="text-secondary">Fecha</th>
    </tr>
  </thead>
  <tbody>
...
<?php
    ...
    $query = "call arca.p_vrAlimentacion_log()";
    $resul = mysqli_query($conn,$query);
    while($fila = mysqli_fetch_array($resul)){
        ?>
        <tr>
            <th scope="row" class="text-secondary"><?php echo $fila['id_alimentacion_log']; ?></th>
                <td><?php echo $fila['operacion']?></td>
                <td><?php echo $fila['id_alimentacion']?></td>
