...
<body>
        ...
        <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="habitat_log.php">Hábitat</a>
              </li>
              <li class="nav-item">
  ...
  <main>
    ...
    <div class="mb-3">
    <h5 class="text-success">HISTORIAL HÁBITAT</h5>
<table class="table table-bordered">
<div class="mb-3">
<thead>
    <tr>
        <th scope="col" class="text-success">#</th>
        <th scope="col" class="text-success">Tipo de operacion</th>
        <th scope="col" class="text-success">ID de Hábitat</th>
        <th scope="col" class="text-success">Nombre del Hábitat</th>
        <th scope="col" class="text-success">Fecha</th>
    </tr>
  </thead>
  <tbody>
...
<?php
    ...
    $query = "call arca.p_vrHabitat_log()";
    $resul = mysqli_query($conn,$query);
    while($fila = mysqli_fetch_array($resul)){
        ?>
        <tr>
            <th scope="row" class="text-success"><?php echo $fila['id_habitat_log']; ?></th>
                <td><?php echo $fila['operacion']?></td>
                <td><?php echo $fila['id_habitat']?></td>
