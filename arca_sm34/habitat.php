...
<body>
  <header>
    ...
    <nav class="navbar navbar-success bg-success bg-opacity-9 fixed-top">
  ...
  <form action="insert\ins_habitat.php" method="post">
<div class="mb-3">
    <label for="input_nombre_habitat" class="form-label">Agregar Habitat</label>
    <input name="nombre_habitat" type="text" class="form-control" id="input_nombre_habitat">
</div>
<div class="mb-3">
...
<thead>
  ...
  <tbody>
    ...
    <th scope="row"><?php echo $c; ?></th>
      ...
      <td><a href = "update\habit.php?id_habitat=<?php echo $fila['id_habitat']?>">
      <i class="bi bi-arrow-up-circle-fill text-success"></i></a></td>
      <td><a href = "delete\del_habitat.php?id_habitat=<?php echo $fila['id_habitat']?>">
      <i class="bi bi-x-circle-fill text-success"></i></a></td>
    </tr>
    <?php $c++; }
    ?>
